...
public class Recording {
	...
	public static void Calla(MemberVo data) {
		...
		if(num==1) {
			double Kresult  = (weight*0.089)*min; break;
		}else if(num==2) {
			double Kresult  =(weight*0.138)*min; break;
		}else if(num==3) {
			double Kresult  =(weight*0.163)*min; break;
		}else if(num==4) {
			double Kresult  =(weight*0.08)*min; break;
		}else if(num==5) {
			double Kresult  =(weight*0.088)*min; break;
		}else if(num==6) {
			double Kresult  =(weight*0.058)*min; break;
		}else if(num==7) {
			double Kresult  =(weight*0.23)*min; break;
		}else {
		...
		new Recording().saveKcal(Kresult, min);
	}
